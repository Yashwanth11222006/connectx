...
const PartnersScrollSection = () => {
  ...
  const supportedByLogos = [
    { name: "Indobox inc.", logo: "/assets/indbox inc.jpg?auto=compress&cs=tinysrgb&w=100" },
    { name: "Indobox inc.", logo: "/assets/indbox inc.jpg?auto=compress&cs=tinysrgb&w=100" },
    { name: "Indobox inc.", logo: "/assets/indbox inc.jpg?auto=compress&cs=tinysrgb&w=100" },
    { name: "Indobox inc.", logo: "/assets/indbox inc.jpg?auto=compress&cs=tinysrgb&w=100" },
    { name: "Indobox inc.", logo: "/assets/indbox inc.jpg?auto=compress&cs=tinysrgb&w=100" },
  ...
  const hiringStartupsLogos = [
    ...
    { name: "RedString", logo: "/assets/redstring.jpg?auto=compress&cs=tinysrgb&w=100" },
    { name: "Nirvaha", logo: "/assets/nirvaha.jpg?auto=compress&cs=tinysrgb&w=100" },
    { name: "StudLyf", logo: "/assets/studlyf123.png?auto=compress&cs=tinysrgb&w=100" },
